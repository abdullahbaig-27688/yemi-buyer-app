...
const PaymentMethodsScreen = () => {
    ...
    const handleSaveChanges = () => {
        let newErrors = {};
        if (!cardData.cardHolder.trim()) newErrors.cardHolder = 'Card holder name is required';
                            ...
                            <View style={styles.row}>
                                <View style={[styles.inputGroup, { flex: 1, marginRight: 10 }]}>
                                    ...
                                    <TextInput
                                        ...
                                        onChangeText={(text) => handleInputChange('valid', formatExpiryDate(text))}
                                        keyboardType="numeric"
                                        maxLength={5}
                                    />
                                    {errors.valid ? <Text style={styles.errorText}>{errors.valid}</Text> : null}
                                </View>
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#fff', paddingHorizontal: 16, paddingVertical:10 },
