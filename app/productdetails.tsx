            ...
            <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.specMetRow}>
                            <Text style={styles.specLabel}>Cotton 55% off</Text>
                            <Text style={styles.specLabel}>   Nylon 5% off</Text>
                        </View>

                        <View style={styles.specOrigin}>
                            <Text style={styles.originLabel}>Origin</Text>
                            <View style={styles.valueview}>
                                <Text style={styles.Value}>EU</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.reviewItem}>
                            ...
                            <Text style={styles.reviewText}>
                                ...
                                nibh euismod tincidunt ut labore et dolore magna aliquam erat, sed ...
                            </Text>
                        </View>

                        {/* View All Reviews Button */}
                        <TouchableOpacity style={styles.viewAllButton}
                        onPress={() => router.replace("/viewallreview")}
